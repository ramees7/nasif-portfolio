...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="flex flex-col sm:justify-center justify-end pb-20 sm:pb-0 h-full pl-16 md:pl-32 lg:pl-48 xl:pl-64">
        <h1 className="md:text-7xl text-5xl font-bold mb-4">{t("landing.name")}</h1>
